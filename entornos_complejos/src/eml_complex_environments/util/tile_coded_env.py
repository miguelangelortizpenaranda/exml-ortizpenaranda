...
class TileCodedEnvironment(ObservationWrapper):
    """
    Implementa una clase que hereda de ObservationWrapper, que nos permite modificar
    observaciones (estados) dentro de un entorno de Gymnasium.
    ...
    def __init__(self, env, bins, low, high, n=4):
        ...
        @param bins: array o lista con el número de intervalos (bins) que hay que particionar cada dimensión.
        @param low: array con el límite inferior de valores para cada dimensión.
        @param high: array con el límite superior para cada dimensión.
        @param n: número de tilings (rejillas) a crear (por defecto 4).
    ...
    def get_last_active_features(self):
        return self.last_active_features
